...
func init() {
	...
	//EXTENSION
	rootCmd.PersistentFlags().BoolVar(&GC.DOHOnly, "doh-only", false, "Only perform lookups over DOH")
	rootCmd.PersistentFlags().BoolVar(&GC.DOH3Only, "doh3-only", false, "Only perform lookups over DOH")
